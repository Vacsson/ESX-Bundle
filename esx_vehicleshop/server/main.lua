...
AddEventHandler('esx_vehicleshop:setVehicleOwned', function (vehicleProps)
  ...
  TriggerClientEvent('revenge-garage:contract', _source, vehicleProps.plate, vehicleProps.model, vehicleProps)
...
AddEventHandler('esx_vehicleshop:setVehicleOwnedPlayerId', function (playerId, vehicleProps)
  ...
  MySQL.Async.execute(
    'INSERT INTO user_vehicles (identifier, plate, model, properties, impounded) VALUES (@identifier, @plate, @model, @properties, @impounded)',
    {
      ["@identifier"] = xPlayer.getIdentifier(),
      ["@plate"] = vehicleProps["plate"],
      ["@model"] = vehicleProps["model"],
      ["@properties"] = json.encode(vehicleProps),
      ["@impounded"] = 0 
    },
...
ESX.RegisterServerCallback('esx_vehicleshop:giveMoneyForResell', function(source, callback, price)
	local xPlayer = ESX.GetPlayerFromId(source)
